      ...
      try:
        ...
        try:
          sent_message = message.reply_text(
              "{} ရေ,\n ညီကို၀င်ရေးလို့မရတာက ဒီ 👉[channel](https://t.me/{})👈 သိုင်းချယ်နယ်ကြီးကိုမ Join ရသေးလို့ဗျာ! \n ချယ်နယ်ကို Join ပြီးပြီဆိုရင်အောက်က Unmute ခလုတ်ကိုနှိပ်လိုက်ပြီး၀င်ရေးလို့ရပါပြီ".format(message.from_user.mention, channel, channel),
